...
class BinLiquidty():
    ...
    def to_dict(self) -> Dict:
        """Convert BinLiquidty object to dictionary."""
        return {
            "bin_id": self.bin_id,
            "price_per_token": self.price_per_token,
            "x_amount": self.x_amount,
            "y_amount": self.y_amount
        }
@dataclass
class GetBins():
    active_bin: int
    ...
    def to_dict(self) -> Dict:
        """Convert GetBins object to dictionary."""
        return {
            "active_bin": self.active_bin,
            "bins": [bin_liquidty.to_dict() for bin_liquidty in self.bin_liquidty]
        }